    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                <p className="section-label">{view === 'list' ? `${subjects.length} Subject${subjects.length !== 1 ? 's' : ''}` : view === 'create' ? 'New Subject' : view === 'edit' ? 'Edit Subject' : 'Subject Notes'}</p>
                {view === 'list' && (
                    <button
            ...
            {view === 'details' && selectedSubject && (
                <div className="space-y-6">
                    ...
                    {showAddNote && (
                        <div className="bg-white border-2 border-slate-800 rounded-3xl p-8 shadow-2xl transition-all">
